4/18 
messed up making devlog, ignore the one without .md

4/19
started working on the bool dfs and the logic for checking bounds, walls, already visited, and marking a space when visited
